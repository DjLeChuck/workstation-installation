...
for SOFTWARE in $SOFTWARES; do
  case $SOFTWARE in
    ...
    '"php"')
      ...
      php5.6-readline php5.6-soap php5.6-sqlite3 php5.6-xml php5.6-xsl php5.6-zip \
      ...
      php7.0-readline php7.0-soap php7.0-sqlite3 php7.0-xml php7.0-xsl php7.0-zip \
      ...
      php7.1-readline php7.1-soap php7.1-sqlite3 php7.1-xml php7.1-xsl php7.1-zip \
      ...
      php7.3-readline php7.3-soap php7.3-sqlite3 php7.3-xml php7.3-xsl php7.3-zip \
      ...
      php7.4-readline php7.4-soap php7.4-sqlite3 php7.4-xml php7.4-xsl php7.4-zip \
      ...
      php8.0-soap php8.0-sqlite3 php8.0-xml php8.0-xsl php8.0-zip"
      ;;
    '"seadrive"')
